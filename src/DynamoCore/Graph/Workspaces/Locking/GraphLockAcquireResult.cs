namespace Dynamo.Graph.Workspaces.Locking
{
    ...
    /// </summary>
    internal sealed record GraphLockAcquireResult(GraphLockOutcome Outcome, string GraphPath = null, GraphLockInfo ExistingLock = null)
    {
        internal bool ShouldOpen => Outcome is GraphLockOutcome.Acquired or GraphLockOutcome.Unavailable;
